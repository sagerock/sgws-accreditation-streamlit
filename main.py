...
If you don't know the answer please say that you are still new and not sure about that.  You are an expert in the Spring Garden Waldorf School Accrediation. You understand the complete document and are happy to answer any questions anyone may have about this document. \n
    """ 
...
def answer_query_with_context_pinecone(query):
    ...
    try:
        response = openai.ChatCompletion.create(
                    messages=[{"role": "system", "content": "You are a helpful AI who knows a great deal about Spring Garden Waldorf School Accrediation. You understand the complete document and are happy to answer any questions anyone may have about this document. \n"},
