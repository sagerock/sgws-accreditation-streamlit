...
alconox_logo = Image.open('images/logo.png')
...
st.set_page_config(page_title="CleanATS - Alconox Tech Support", page_icon="images/icon.png", layout="wide")

st.header("Ask you critical cleaning question from CleanATS - Alconox Tech Support \n")
st.image('images/icon.png', width=50)


# st.header("Thank you for visiting Ask Alconox AI \n")
...
alconox_url = "https://alconox.com/"
ask_url ="https://www.alconox.com/ask-alconox/"
technotes_url = "https://technotes.alconox.com/"
...
with st.sidebar:
    ...
    st.markdown("# About 🧪")
    st.markdown(
        "Alconox Inc. is dedicated to being the leader in critical cleaning detergents. \n"
        "We manufacture quality detergents made in the United States and provide outstanding \n"
        "technical service to the scientists and engineers with precision cleaning needs. \n"
        )

    st.markdown("---")
    st.markdown("Learn more about [Alconox](%s)." %alconox_url)
    st.markdown("Ask Alconox more questions [here](%s)" %ask_url)
    st.markdown("Check out TechNotes [here](%s)" %technotes_url)
    st.markdown("---")
